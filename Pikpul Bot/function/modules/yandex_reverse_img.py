...
from pikpulbot.function import convert_to_image
...
@pikpul.on(pikpul_on_cmd(pattern=r"yandex"))
@pikpul.on(sudo_cmd(pattern=r"yandex", allow_sudo=True))
async def hmm(event):
...
<u><b>Reverse Search Completed By Pipul.
Get Your Own Friday From @PIKPULCHAT.</b></u>
"""
