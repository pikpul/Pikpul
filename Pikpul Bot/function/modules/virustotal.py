...
from Pikpulbot import CMD_HELP, TEMP_DOWNLOAD_DIRECTORY
...
@Pikpul.on(friday_on_cmd(pattern="vt(?: |$)(.*)", outgoing=True))
@Pikpul.on(sudo_cmd(pattern="vt(?: |$)(.*)", allow_sudo=True))
async def download(target_file):
    ...
    if target_file.reply_to_msg_id:
        ...
        await Pikpul.edit("Reply to a file..")
    ...
    try:
        ...
        await Pikpul.edit("your file is larger than 32 mb.")
    try:
        await Pikpul.edit(
            f"<b><u> File Scan Request Complete</u></b>\n\n<b>Link of the report:-</b>\n{b}\n\nNote:- Please open the link after 5-10 minutes.\n\n<b>Virus Scan Completed By Pikpul\nGet Your Own Pikpul From @Gianicbotsupport</b>",
            parse_mode="HTML",
        )
    except:
        await Pikpul.edit("your file is larger than 32 mb.   --__--")
