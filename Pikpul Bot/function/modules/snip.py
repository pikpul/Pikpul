...
from pikpulbot.modules.sql_helper.snips_sql import (
    add_snip,
    get_all_snips,
    get_snips,
    remove_snip,
...
@pikpul.on(events.NewMessage(pattern=r"\#(\S+)", outgoing=True))
...
@pikpul.on(pikpul_on_cmd("snipd (\S+)"))
