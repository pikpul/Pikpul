"""Remove.BG Plugin for @Gianicbotsupport
...
async def _(event):
    ...
    if "image" in contentType:
        ...
        await event.edit(
            "Removed image's Background in {} seconds, powered by @PikpulOT".format(ms)
        )
    else:
        await event.edit(
            "ReMove.BG API returned Errors. Please report to @PikpulOT\n`{}".format(
